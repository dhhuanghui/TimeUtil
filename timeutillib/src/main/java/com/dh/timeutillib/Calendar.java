...
public final class Calendar implements Serializable {
     ...
     * 是否显示节气
     */
    private boolean isShowJieQi;
    /**
     * 是否显示节日
     */
    private boolean isShowJieRi;
    ...
    public boolean isShowJieQi() {
        return isShowJieQi;
    }

    public boolean isShowJieRi() {
        return isShowJieRi;
    }

    public void setShowJieQi(boolean showJieQi) {
        isShowJieQi = showJieQi;
    }

    public void setShowJieRi(boolean showJieRi) {
        isShowJieRi = showJieRi;
    }
